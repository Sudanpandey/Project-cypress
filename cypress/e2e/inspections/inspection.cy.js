...
describe("Inspection", () => {
    it("Should display error message for empty Inspection", () => {
      ...
      it("should display the upload the images", function() {
        ...
        cy.get('#child-3 > .ctb-inspect-inside-row > :nth-child(1) > .col-md-6 > :nth-child(1) > .m-t-15 > :nth-child(1) > :nth-child(2) > .btn > span').click();
        ...
        cy.get('#child-1608825595546 > .ctb-inspect-inside-row > :nth-child(1) > .col-md-6 > :nth-child(1) > .m-t-15 > :nth-child(1) > :nth-child(2) > .btn > span').click();
        ...
        cy.contains('button[type="button"]', 'Volgende').click();
        cy.wait(2000);
        cy.get('#child-1609247279598 > .ctb-inspect-inside-row > :nth-child(1) > .col-md-6 > :nth-child(1) > :nth-child(1) > .form-control').type("No image upload");
        cy.contains('button[type="button"]', 'Volgende').click();
        cy.get('.h5 > .btn').click();
        cy.wait(2000);
        ...
        cy.wait(2000);
        cy.get('[data-target="#collapse_image_1608825595546"] > .label-text > .mdi').click();
        cy.wrap(fileNamesStep3).each((fileName) => {
          expect(fileNamesStep3).to.include(fileName);
        });
